...
ORIGINAL_PREFIXE_LINES = [
    "-o option\n",
]
ORIGINAL_PACKAGE_LINES = [
    "package==0.0.1\n",
]
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            True,
            PREFIXES_OVERLAP,
            NEW_PREFIXES_OVERLAP + ORIGINAL_PACKAGE_LINES,
        ),
    ],
)
def test_dump(
...
@pytest.mark.parametrize(
    "touch_file,keep_original_prefixes,prefixes,expected_lines",
    [
...
def test_dump_empty_original_list(
    monkeypatch, touch_file, keep_original_prefixes, prefixes, expected_lines
):
