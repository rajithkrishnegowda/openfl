...
class TestFlowParticipantName(FLSpec):
    ...
    def join(self, inputs):
        ...
        for input in enumerate(inputs):
            ...
            if hasattr(input, "train_loader") is True or hasattr(input, "test_loader") is True:
                # Error - we are able to access collaborator attributes
                TestFlowParticipantName.ERROR_LIST.append("join_collaborator_attributes_found")
                print(
...
def validate_collab_private_attr(self, private_attr, step_name):
    ...
    if hasattr(self, private_attr) is False:
        TestFlowParticipantName.ERROR_LIST.append(step_name + "_aggregator_attributes_missing")
        print(
    ...
    for idx, collab in enumerate(self.collaborators):
        ...
        if (
            ...
            # Error - we are able to access collaborator attributes
            TestFlowParticipantName.ERROR_LIST.append(step_name + "_collaborator_attributes_found")
            print(
...
def validate_agg_private_attrs(self, private_attr_1, private_attr_2, step_name):
    ...
    if not hasattr(self, private_attr_1) or not hasattr(self, private_attr_2):
        TestFlowParticipantName.ERROR_LIST.append(step_name + "collab_attributes_not_found")
        print(
    ...
    if hasattr(self.runtime, "_aggregator") and isinstance(self.runtime._aggregator, Aggregator):
        ...
        TestFlowParticipantName.ERROR_LIST.append(step_name + "_aggregator_attributes_found")
        print(
