...
from tests.github.interactive_api_director.experiments.pytorch_kvasir_unet.data_loader import (
    read_data,
)
...
class KvasirDataset(Dataset):
    ...
    def __init__(
        self,
        images_path="./data/segmented-images/images/",
...
class FedDataset(DataInterface):
    def _delayed_init(self, data_path="1,1"):
        ...
        self.valid_set = self.UserDatasetClass(
            validation_fraction=validation_fraction, is_validation=True
        )
