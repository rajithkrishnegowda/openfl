...
class CIFAR10ShardDescriptor(ShardDescriptor):
    ...
    def __init__(self, rank_worldsize: str = "1, 1", **kwargs):
        ...
        train_ds, valid_ds = self._download_and_prepare_dataset(
            rank=self.rank, worldsize=self.worldsize
        )
    ...
    def _download_and_prepare_dataset(
        ...
        # Split
        x_train, y_train = (
            x_train[rank - 1 :: worldsize],
            y_train[rank - 1 :: worldsize],
        )
        x_test, y_test = (
            x_test[rank - 1 :: worldsize],
            y_test[rank - 1 :: worldsize],
        )
    ...
    def dataset_description(self) -> str:
        ...
        return (
            f"CIFAR10 dataset, shard number {self.rank}/{self.worldsize}."
